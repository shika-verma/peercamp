...
<a href="<?php echo esc_url( $link ); ?>"
	...
	class="masterstudy-nav-button <?php echo esc_attr( $dark_mode_class ); ?> <?php echo esc_attr( $type_class ); ?> <?php echo esc_attr( $style_class ); ?> <?php echo esc_attr( $last_btn_class ); ?>"
