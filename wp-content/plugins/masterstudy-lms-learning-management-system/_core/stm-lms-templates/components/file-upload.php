...
<div class="masterstudy-file-upload <?php echo esc_attr( $dark_mode ? 'masterstudy-file-upload_dark-mode' : '' ); ?>">
	...
	if ( ! $readonly ) {
		?>
		<div id="masterstudy-file-upload-field" class="masterstudy-file-upload__field">
			...
			<div class="masterstudy-file-upload__field-text">
				<p><?php echo esc_html__( 'Drag files here or click the button.', 'masterstudy-lms-learning-management-system' ); ?></p>
				<?php
