...
if ( ! empty( $course_price ) ) : ?>
	...
	?>
		...
		<?php echo STM_LMS_Point_System::display_point_image(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
			...
			<span class="masterstudy-points__price"><?php echo STM_LMS_Point_System::display_points( $course_price ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> Coin</span>
