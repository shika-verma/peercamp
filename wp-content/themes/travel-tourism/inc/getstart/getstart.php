    ...
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks" onclick="travel_tourism_open_tab(event, 'block_pattern')"><?php esc_html_e( 'Setup With Block Pattern', 'travel-tourism' ); ?></button>	
		  	...
		  	<button class="tablinks" onclick="travel_tourism_open_tab(event, 'product_addons_editor')"><?php esc_html_e( 'Woocommerce Product Addons', 'travel-tourism' ); ?></button>	
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($travel_tourism_plugin_custom_css); ?>">
				<div class="block-pattern-img">
					...
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','travel-tourism'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon.','travel-tourism'); ?></span></b></p>
	              	<div class="travel-tourism-pattern-page">
				    	...
				    	<p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Sections >> Publish.','travel-tourism'); ?></span></b></p>
		...
		<div id="product_addons_editor" class="tabcontent">
			<?php if(!class_exists('IEPA_Loader')){
				$plugin_ins = Travel_Tourism_Plugin_Activation_Woo_Products::get_instance();
				$travel_tourism_actions = $plugin_ins->recommended_actions;
				?>
				<div class="travel-tourism-recommended-plugins">
					    <div class="travel-tourism-action-list">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Woocommerce Products Blocks', 'travel-tourism' ); ?></h3>
				<hr class="h3hr">
				<div class="travel-tourism-pattern-page">
					<p><?php esc_html_e('Follow the below instructions to setup Products Templates.','travel-tourism'); ?></p>
					<p><b><?php esc_html_e('1. First you need to activate these plugins','travel-tourism'); ?></b></p>
						<p><?php esc_html_e('1. Ibtana - WordPress Website Builder ','travel-tourism'); ?></p>
						<p><?php esc_html_e('2. Ibtana - Ecommerce Product Addons.','travel-tourism'); ?></p>
						<p><?php esc_html_e('3. Woocommerce','travel-tourism'); ?></p>

					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','travel-tourism'); ?></span></b></p>
	              	<div class="travel-tourism-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-woocommerce-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','travel-tourism'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','travel-tourism'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
		...
		<div id="travel_tourism_pro" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( TRAVEL_TOURISM_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Pro', 'travel-tourism'); ?></a>
