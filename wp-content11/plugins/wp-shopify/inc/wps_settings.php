...
<li><a href="https://<?php echo $wpsy_db_data['wpsy_url']; ?>" target="_blank"><i style="color:#96BF48;" class="fab fa-shopify"></i> <?php _e("Go to Store",'wp-shopify'); ?></a></li>
<li><a href="https://accounts.shopify.com/store-login" target="_blank"><i style="color:#F93;" class="fas fa-user-lock"></i> <?php _e("Store Login",'wp-shopify'); ?></a></li>
<li><a href="https://<?php echo $wpsy_db_data['wpsy_url']; ?>/admin/apps/development" target="_blank"><i style="color:#369;" class="fas fa-rocket"></i> <?php _e("Application / API Credentials",'wp-shopify'); ?></a></li>
<li><a href="https://<?php echo $wpsy_db_data['wpsy_url']; ?>/admin/collections" target="_blank"><i style="color:#C3C;" class="fas fa-boxes"></i> <?php _e("Create Collections",'wp-shopify'); ?></a></li>
...
<?php endif; ?>
        ...
        <div class="row mt-3">
            ...
            <br /><br />
			<small><?php echo __('OR'); ?> [wp-shopify-product id="<?php echo __('some product ID', 'wp-shopify'); ?>"]</small>
            <br /><br />
			<small><?php echo __('OR'); ?> [wp-shopify-product id="<?php echo __('some product ID', 'wp-shopify'); ?>" <i class="red">template="bello-sole"</i>] <b class="red">(<?php echo __('Premium Version', 'wp-shopify'); ?>)</b><br />
<br />
add_action('wp-shopify-product-after-description', 'callback_func'); //FOR EXTRA HTML BASED CONTENT
</small>

            <br /><br /></li>
            <li>[wp-shopify type="collection" id="141421936749" limit="4"]</li>
    ...
    <div class="nav-tab-content container-fluid hides tab-help" data-content="help">
        ...
        <div class="row mt-3">
            ...
            <ul class="position-relative">
                <li><a class="btn btn-sm btn-info" href="https://wordpress.org/support/plugin/wp-shopify/" target="_blank"><?php _e('Open a Ticket on Support Forums', 'wp-shopify'); ?> &nbsp;<i class="fas fa-tag"></i></a></li>
                <li><a class="btn btn-sm btn-warning" href="http://demo.androidbubble.com/contact/" target="_blank"><?php _e('Contact Developer', 'wp-shopify'); ?> &nbsp;<i class="fas fa-headset"></i></a></li>
                <li><a class="btn btn-sm btn-secondary" href="<?php echo $wpsy_premium_copy; ?>/?help" target="_blank"><?php _e('Need Urgent Help?', 'wp-shopify'); ?> &nbsp;<i class="fas fa-phone"></i></i></a></li>
